    ...
    <div className="spark-code my-7 overflow-hidden rounded-xl bg-[var(--spark-ink)]">
      <div className="flex items-center justify-between border-b border-white/[0.07] px-4 py-3">
        <div className="flex items-center gap-3">
          <span className="spark-eyebrow text-[var(--spark-amber)]">
            {label}
          </span>
          {file && (
        ...
        <button
          onClick={copy}
          className="rounded-md px-3 py-1 text-[10.5px] font-medium text-[var(--spark-on-dark-muted)] transition-colors hover:bg-white/[0.07] hover:text-[var(--spark-screen-ink)]/80"
            ...
            <React.Fragment key={i}>
              ...
              {note && (
                <div className="px-5 py-2 pl-[44px]">
                  <div className="flex items-start gap-2.5 rounded-lg border border-dashed border-[rgba(255,184,77,0.4)] bg-[rgba(255,184,77,0.08)] px-3 py-2.5">
                    <span className="spark-eyebrow shrink-0 pt-0.5 text-[var(--spark-amber)]">
                      Note
                    </span>
