  ...
  return (
    ...
    >
      <g fill="#fbf9f3">
        <path
          fillRule="evenodd"
          d="M184.2,15.4c-8.6-9.4-20.9-15.4-33.8-15.4H18.1C7.9,0,0,9.1,0,18.9v56.3c0,10.1,8.2,18.8,18.5,18.8h132.1c18.2,0,34.4-11.7,41.6-27.5,7.9-17.4,4.7-37.3-8-51.2h0ZM150.1,67.9H26.2V26.1h124.2c11.4.4,20,9.9,20,20.9s-8.8,20.4-20.2,20.9h0Z"
        />
...
function CoverlyPreview() {
  return (
    <svg
      viewBox="0 0 303.28 303.38"
      width="100%"
      height="100%"
      preserveAspectRatio="xMidYMid meet"
      className="hpp-svg"
    >
      <g fill="#fbf9f3">
        <path d="M301.24,181.64c-1.9-2.1-3.9-4.3-6.1-6.5-13.7-13.7-28.9-21.3-44.3-23.6,15.7-2.4,30.6-10.2,43.1-22.7,2.6-2.6,5-5.2,7.1-7.8,2.6-3.2,2.4-7.8-.5-10.8L192.64,2.34c-3-3-7.8-3.1-10.9-.4-2.1,1.9-4.3,3.9-6.5,6.1-13.7,13.7-21.2,28.7-23.5,44-2.5-15.5-10.2-30.2-22.6-42.6-2.7-2.7-5.2-5-7.8-7.2-3.2-2.7-7.8-2.4-10.8.5L2.34,110.74c-3,3-3.1,7.8-.4,10.9,1.9,2.2,3.9,4.4,6.2,6.6,13.6,13.6,28.7,21.2,44,23.5-15.6,2.5-30.4,10.2-42.8,22.7-2.7,2.6-5,5.2-7.2,7.8-2.7,3.2-2.4,7.8.5,10.8l108,108c3,3,7.8,3.1,10.9.4,2.1-1.9,4.3-3.9,6.5-6.1,13.7-13.7,21.3-28.9,23.6-44.2,2.5,15.6,10.2,30.4,22.7,42.9,2.6,2.6,5.2,5,7.8,7.1,3.2,2.6,7.8,2.4,10.8-.5l108-108c3-3,3.1-7.8.4-10.9h0l-.1-.1ZM178.64,179.04c-15.7,15.7-24.5,33.1-27.1,50.4-2.8-18.2-12.5-35.8-27.4-50.7-15.6-15.6-33-24.4-50.2-27,18.2-2.9,35.8-12.5,50.7-27.4s24.5-33,27-50.2c2.9,18.1,12.6,35.6,27.4,50.5,14.8,14.9,33.2,24.6,50.5,27.1-18.3,2.8-36,12.5-50.9,27.5h0v-.2Z" />
      </g>
    </svg>
  );
}
...
function PromptrPreview() {
  return (
    <svg viewBox="0 0 160 90" width="100%" height="100%" className="hpp-svg">
      ...
      >
        <path
          d="M34 30 Q42 25, 50 30 T66 30 T82 30 T98 30 T114 30"
          className="hpp-pr-wavy hpp-pr-r1"
        />
        <line
          x1="34"
          y1="30"
          x2="118"
          y2="30"
          className="hpp-pr-sharp hpp-pr-r1"
        />

        <path
          d="M34 45 Q40 41, 46 45 T58 45 T70 45 T82 45 T94 45 T106 45"
          className="hpp-pr-wavy hpp-pr-r2"
        />
        <line
          x1="34"
          y1="45"
          x2="108"
          y2="45"
          className="hpp-pr-sharp hpp-pr-r2"
        />

        <path
          d="M34 60 Q42 56, 50 60 T66 60 T82 60 T98 60"
          className="hpp-pr-wavy hpp-pr-r3"
        />
        <line
          x1="34"
          y1="60"
    ...
    <svg viewBox="0 0 160 90" width="100%" height="100%" className="hpp-svg">
      <g className="hpp-ka-stack">
        <text
          ...
          fill="currentColor"
          className="hpp-ka-letter hpp-ka-a"
        >
          A
        </text>
        <text
          ...
          fontFamily="var(--font-playfair, serif)"
          fill="currentColor"
          className="hpp-ka-letter hpp-ka-b"
        >
          B
        </text>
        <text
          ...
          fontFamily="var(--font-playfair, serif)"
          fill="currentColor"
          className="hpp-ka-letter hpp-ka-c"
        >
          C
        </text>
      </g>
