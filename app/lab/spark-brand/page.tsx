...
export default async function SparkBrandLabPage() {
  ...
  return (
    <div className={styles.page}>
        ...
        <section id="hero" className={`${styles.shell} ${styles.hero}`}>
          ...
          <div className={styles.heroFoot}>
            <p className={styles.lede}>
              Most designers can prompt their way to an app. Few can open an
              empty file and write one. Spark teaches you how, one line at a
              time.
            </p>
      ...
      <div className={styles.labBar}>
        Spark brand lab
        <Link href="/lab/spark-brand/direction">Brand direction</Link>
      </div>
    </div>
  );
}
