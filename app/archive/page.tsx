...
function Row({ entry }: { entry: Entry }) {
  const inner = (
    <>
      <div className="flex-1 min-w-0">
        ...
        <p
          className="text-site-ink/60 mt-1.5"
          style={{
            fontFamily: "var(--font-inter)",
            fontSize: "0.9375rem",
            lineHeight: 1.55,
      ...
      <svg
        className="w-4 h-4 mt-1.5 flex-shrink-0 text-site-accent group-hover:translate-x-1 group-hover:-translate-y-0.5 transition-transform"
        aria-hidden="true"
        fill="none"
        viewBox="0 0 24 24"
        stroke="currentColor"
  ...
  const cls =
    "group flex items-start gap-5 py-5 border-b border-site-ink/10 transition-colors hover:border-site-accent/30";
  ...
  return (
    <SitePage>
      <div className={`${GeistMono.variable} max-w-3xl pb-24`}>
        ...
        <p
          className="text-site-ink/60 mt-5 max-w-md"
          style={{
            fontFamily: "var(--font-inter)",
            fontSize: "1.0625rem",
            lineHeight: 1.6,
        ...
        <div className="mt-16 space-y-16">
          {GROUPS.map((group) => (
            <section key={group.label}>
              ...
              <div className="border-t border-site-ink/10">
