          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 mb-8 sm:mb-12">
            <div>
              ...
              <a
                ...
                className="group inline-flex items-center gap-2 mt-4 sm:mt-6 px-5 py-3 border-2 border-[#fbf9f3]/80 text-[#fbf9f3] hover:bg-[#fbf9f3] hover:border-[#fbf9f3] hover:text-black transition-all whitespace-nowrap"
                style={{
                  fontFamily: "var(--font-jetbrains-mono)",
                  fontSize: "0.75rem",
                  fontWeight: 500,
