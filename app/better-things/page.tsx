    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="grid md:grid-cols-2 gap-8">
        <div className="bg-white rounded-lg shadow-lg overflow-hidden">
          <Image src="/nuk-soo-card-banner.png" alt="NUK SOO" width={600} height={400} className="w-full h-64 object-cover" />
          <div className="p-6">
        ...
        <div className="bg-white rounded-lg shadow-lg overflow-hidden">
          <Image
            src="/gatewick-house-gardens-card-banner.png"
            alt="Gatewick House & Gardens"
            width={600}
            height={400}
