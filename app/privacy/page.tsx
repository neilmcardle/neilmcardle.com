...
const LINK = "text-site-accent hover:text-site-accent-strong transition-colors";

export default function PrivacyPage() {
  return (
    <SitePage>
      <div className="home-prose max-w-3xl pb-24">
        <h1
          className="text-site-ink mb-6"
          style={{
        ...
        <Section title="1. Who is responsible for your data">
          The data controller for neilmcardle.com is Neil McArdle, a sole trader
          based in London, England, operating under UK GDPR. You can reach me at{" "}
          <a href="mailto:neil@neilmcardle.com" className={LINK}>
        ...
        <Section title="2. What I collect">
          <ul className="list-disc pl-5 space-y-2 mt-1">
            <li>
              <strong className="text-site-ink/85">When you contact me:</strong>{" "}
            ...
            <li>
              <strong className="text-site-ink/85">Automatically:</strong>{" "}
              aggregate, anonymous page-view statistics through Vercel
              Analytics, which is cookie-less and does not identify you or track
              you across sites.
            </li>
          </ul>
        </Section>
        ...
        <Section title="5. Cookies">
          <ul className="list-disc pl-5 space-y-2 mt-1">
            <li>
              <strong className="text-site-ink/85">Necessary:</strong> a small
              cookie that remembers your cookie-consent choice so you are not
              asked repeatedly.
            </li>
            <li>
              <strong className="text-site-ink/85">Analytics:</strong> Vercel
              Analytics is cookie-less, so it sets nothing on your device.
            </li>
            <li>
              <strong className="text-site-ink/85">
                Advertising and measurement (consent only):
              </strong>{" "}
              set only if you accept through the cookie banner, and removed when
              you withdraw consent. Until you consent, no advertising cookies
              are set and no identifiers are sent to Google.
            </li>
          </ul>
        </Section>

        <Section title="6. Retention">
          I keep correspondence for as long as needed to handle your enquiry and
          any resulting work, plus a reasonable period for legal and accounting
          purposes. Billing records are kept for six years as UK tax law
          requires. You can ask me to delete your data at any time, subject to
          those obligations.
        </Section>

        <Section title="7. Your rights">
          Under UK GDPR you have the right to access, correct, delete, restrict,
          or object to the processing of your personal data, the right to data
          portability, and the right to withdraw consent at any time. To
          exercise any of these, email me and I will respond within one month.
        </Section>
        ...
        <Section title="9. Complaints">
          If you are unhappy with how I handle your data, please tell me first
          so I can put it right. You also have the right to complain to the
        ...
        <Section title="10. Changes">
          I may update this policy from time to time. The date at the top shows
