          ...
          <div className="prose prose-gray max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                By accessing and using makeebook at{" "}
                <a
                  href="https://makeebook.ink"
                  className="text-blue-600 hover:underline"
                >
                ...
                with any of these terms, you are prohibited from using the
                Service.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                ...
                account by providing a valid email address and password. You are
                responsible for:
              </p>
              <ul className="list-disc list-inside text-gray-700 mb-4 space-y-2">
                <li>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                ...
                violation of these Terms of Service. You may terminate your
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                ...
                Wales. Any disputes arising from these terms shall be subject to
