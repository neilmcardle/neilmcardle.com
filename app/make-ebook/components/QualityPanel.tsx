...
export function QualityScoreBadge({ score, compact = false }: QualityScoreBadgeProps) {
  ...
  if (compact) {
    return (
      <div className={`inline-flex items-center gap-0.5 sm:gap-1 px-1.5 py-0.5 sm:px-2 sm:py-1 rounded-full text-2xs sm:text-xs font-medium ${getColor()}`}>
      ...
      <div className="flex-1 min-w-0">
        ...
        {issue.hint && (
          <div className="text-xs text-gray-500 dark:text-[#a3a3a3] mt-1 flex items-start gap-1.5">
            <svg className="w-3.5 h-3.5 flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.6}>
