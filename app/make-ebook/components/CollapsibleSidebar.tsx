...
export default function CollapsibleSidebar(props: CollapsibleSidebarProps) {
  ...
  return (
    ...
    >
      <div ref={innerRef} className="flex flex-col h-full bg-white dark:bg-[#1e1e1e] border-r border-gray-200 dark:border-[#2f2f2f]" style={{ width, minWidth: width }}>
        ...
        {multiSelectMode && libraryBooks.length > 0 && (
              <div className="flex items-center justify-between mt-2 px-2 py-1.5 bg-gray-50 dark:bg-[#262626] rounded-md">
                <button
                  ...
                  className="text-xs text-[#4070ff] hover:underline"
                >
        ...
        <div className="flex items-center justify-between py-2 px-2">
          <div className="flex items-center gap-2 flex-1 min-w-0">
            ...
            <div className="flex flex-col gap-0.5 flex-1 min-w-0">
              ...
              {title && (
                <span className="text-xs text-gray-600 dark:text-[#a3a3a3] truncate">
                  {title}
                </span>
              )}
            </div>
          ...
          <div data-tour="export" className="flex items-center gap-1 flex-shrink-0">
            <button
              ...
              className={`flex flex-col items-center gap-0.5 px-2 py-1 hover:bg-gray-50 dark:hover:bg-[#262626] rounded transition-all disabled:opacity-50 ${saveFeedback ? 'bg-green-50 dark:bg-green-900/20' : ''}`}
              ...
              {chapterTypeDropdownOpen && (
                <div className="absolute right-0 top-full mt-1 w-56 bg-white dark:bg-[#1e1e1e] rounded-lg shadow-xl border border-gray-200 dark:border-[#2f2f2f] z-50 py-2 max-h-96 overflow-y-auto">
                  <div className="space-y-3 px-2">
                    {/* Front Matter */}
                    <div>
                      <div className="px-3 py-1 text-xs font-semibold text-gray-600 dark:text-[#a3a3a3] uppercase">
                        Front Matter
                      </div>
