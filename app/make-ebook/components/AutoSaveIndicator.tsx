...
export function AutoSaveIndicator({ isDirty, isSaving, lastSaved, compact = false, hasCloudSync = false }: AutoSaveIndicatorProps) {
  ...
  if (isSaving) {
    ...
    return (
      <div className="flex items-center gap-2 h-10 px-3 rounded-lg bg-gray-100 dark:bg-[#262626] text-xs text-gray-500 dark:text-[#a3a3a3]">
  ...
  if (isDirty) {
    ...
    return (
      <div className="flex items-center gap-2 h-10 px-3 rounded-lg bg-gray-100 dark:bg-[#262626] text-xs text-stone-600 dark:text-stone-400">
