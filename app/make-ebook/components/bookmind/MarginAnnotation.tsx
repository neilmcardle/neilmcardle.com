...
// Craft notes in the right gutter. When Flow mode is on, the editorial
// brain periodically analyzes the current chapter and drops short
// craft annotations (dialogue-tag overload, repeated openings, pacing).
// Each note is one sentence max and links to the line it references.
// Generated by a debounced call every 30 seconds of editing or 200 new
// words (whichever comes first). Results are component-local and reset
// when the user changes chapters or closes Flow mode.
