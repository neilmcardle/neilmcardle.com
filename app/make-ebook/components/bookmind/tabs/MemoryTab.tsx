...
export default function MemoryTab({ book, userId, onUpdate }: MemoryTabProps) {
        ...
        <div className="flex-1 flex items-center justify-center p-8">
          <div className="text-center space-y-3 max-w-[260px]">
            ...
            <p className="text-sm text-gray-500 dark:text-[#a3a3a3]">
              No memory yet. Use the chat to teach Book Mind about your
              manuscript.
            </p>
          </div>
        </div>
  ...
  return (
    ...
    >
      <div className="flex items-start justify-between gap-2 mb-2">
        <span
          className={`text-[10px] font-semibold uppercase tracking-wide px-2 py-1 rounded ${colors.bg} ${colors.text}`}
        >
          {colors.label}
        </span>
        {!isDeleting ? (
          <button
            ...
            className="me-reveal text-2xs text-gray-400 hover:text-red-600 dark:hover:text-red-400 px-1"
            title="Delete"
          >
            Delete
          </button>
