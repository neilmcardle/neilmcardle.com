  ...
  return (
    <div className="mb-3 rounded-lg border border-gray-200 dark:border-[#3a3a3a] bg-white dark:bg-[#252525] p-3">
      <div className="flex items-start gap-2 mb-2">
        <svg className="w-4 h-4 mt-1 text-gray-500 dark:text-[#a3a3a3] flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.6} strokeLinecap="round" strokeLinejoin="round">
      ...
      <div className="grid grid-cols-2 gap-2 mb-2 text-2xs">
        <div className="p-2 rounded-md bg-gray-50 dark:bg-[#1e1e1e] border border-gray-200 dark:border-[#333]">
          <p className="font-semibold text-gray-700 dark:text-[#d4d4d4] mb-1">This device</p>
        ...
        <div className="p-2 rounded-md bg-gray-50 dark:bg-[#1e1e1e] border border-gray-200 dark:border-[#333]">
          <p className="font-semibold text-gray-700 dark:text-[#d4d4d4] mb-1">Cloud</p>
      ...
      <div className="flex flex-col gap-2">
        ...
        <button
          ...
          className="w-full px-3 py-2 rounded-md border border-gray-200 dark:border-[#2f2f2f] bg-white dark:bg-[#1e1e1e] text-xs font-medium text-gray-900 dark:text-gray-100 hover:bg-gray-50 dark:hover:bg-[#262626] transition-colors"
        >
