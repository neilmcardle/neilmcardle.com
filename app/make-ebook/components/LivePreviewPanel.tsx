        ...
        {viewMode === 'page' && (
          <div className="flex items-center gap-4">
            <button
              ...
              className="w-8 h-8 rounded-full flex items-center justify-center bg-gray-200 dark:bg-[#2f2f2f] text-gray-600 dark:text-[#d4d4d4] hover:bg-gray-300 dark:hover:bg-[#3a3a3a] disabled:opacity-30 disabled:cursor-not-allowed transition-colors"
