    ...
    <footer className="pt-20 pb-12 sm:pt-24 sm:pb-16 border-t border-[#2f2f2f]">
      <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-16">
          ...
          <div className="col-span-2 md:col-span-4">
            ...
            <p className="text-sm text-white/40 max-w-xs text-pretty">
              ...
              <a
                ...
                className="underline decoration-white/20 hover:decoration-white/60 hover:text-white/70 transition-colors"
              >
                neilmcardle.com
              </a>{" "}
              project. Made with care, in the open.
            </p>
          </div>

          <div className="md:col-span-3">
            <h4 className="text-xs font-semibold mb-4 text-white/50 uppercase tracking-widest">
              Product
            </h4>
        ...
        <div className="mt-16 pt-8 border-t border-[#2f2f2f] flex flex-wrap items-center justify-between gap-4 text-sm text-white/25">
          <p>
            &copy; {new Date().getFullYear()} Neil McArdle. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
