...
export default async function BlogPostPage({ params }: PageProps) {
  ...
  return (
    <div className="relative min-h-screen bg-me-cream text-gray-700">
      ...
      <article
        id="main-content"
        className="max-w-3xl mx-auto px-6 sm:px-10 pt-16 sm:pt-20 pb-24"
      >
        <Link
        ...
        {post.faqs && post.faqs.length > 0 && (
          <section className="mt-16 pt-12 border-t border-gray-200">
            <h2
              className="font-serif font-bold text-gray-900 text-2xl mb-8"
            ...
            <dl className="space-y-8">
              {post.faqs.map((f, i) => (
                <div key={i}>
                  ...
                  <dd className="text-gray-700 leading-relaxed text-pretty">
                    {f.a}
                  </dd>
                </div>
              ))}
        ...
        <div className="mt-20 p-8 sm:p-10 bg-white rounded-2xl border border-gray-200 text-center">
          <h3
            ...
            style={{
              fontSize: "clamp(1.5rem, 1vw + 1.25rem, 2rem)",
          ...
          <p
            className="text-gray-600 mb-6 max-w-md mx-auto text-pretty"
            style={{ fontFamily: "Georgia, serif", lineHeight: 1.55 }}
          >
