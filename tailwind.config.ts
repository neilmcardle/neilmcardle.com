...
const config = {
  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        'border': '0px 0px 0px 1px rgba(0, 0, 0, 0.055), 0px 2px 3px -1px rgba(0, 0, 0, 0.05), 0px 2px 5px 0px rgba(0, 0, 0, 0.03)',
        'border-hover': '0px 0px 0px 1px rgba(0, 0, 0, 0.075), 0px 2px 3px -1px rgba(0, 0, 0, 0.07), 0px 2px 5px 0px rgba(0, 0, 0, 0.04)',
      },
    },
  },
  plugins: [
