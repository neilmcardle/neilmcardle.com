...
**Loading.** The model is computing. Streaming has not started yet. This is the moment the user needs confidence that something _is_ happening. A spinner is honest. So is a skeleton with a gentle pulse.
