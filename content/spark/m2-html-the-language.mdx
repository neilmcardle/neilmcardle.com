...
Both render identically. The semantic version is shorter, clearer, and works better for assistive technology. Care about how you build it. A semantic page is easier to style, faster to load, more accessible by default, and honest in its structure.
