...
Your data lives here now. Everything you built in M14 ,  the waitlist signups, the blog post drafts, the comment threads ,  was in memory. Refresh the browser, gone. Real products need real persistence.
...
## Build: Persist M14's Data

Your assignment: take the waitlist and blog platform from M14 and give it real persistence.
...
In your M14 API routes, replace in-memory storage with database calls:
