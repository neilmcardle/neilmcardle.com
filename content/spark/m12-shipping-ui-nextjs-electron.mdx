---
title: "M12: Shipping UI ,  Next.js + Desktop/Electron"
...
# M12: Shipping UI ,  Next.js + Desktop/Electron
...
export function AddBookForm({ onSuccess }: AddBookFormProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4 max-w-md mx-auto">
      ...
      {/* Pages field */}
      <div>
        <label className="block text-sm font-medium mb-1">Pages (optional)</label>
        <input
          type="text"
          ...
          disabled={isSubmitting}
        />
        {errors.pages && <p className="text-sm text-red-600 mt-1">{errors.pages}</p>}
      </div>
