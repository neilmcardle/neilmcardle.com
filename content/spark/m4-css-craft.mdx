---
title: "CSS Craft"
promise: "Recreate a real design pixel for pixel, then add one transition that earns its place."
...
prerequisites: ["Foundations", "Components", "Flex + Grid"]
learning_outcomes:
...
The best transitions are _subtle_. They should feel necessary, not ornamental.
...
- Does the user _need_ to see this change?
...
In JavaScript fundamentals, you'll learn how to think about color systematically. You'll build a color palette from scratch and apply it to an interface.
