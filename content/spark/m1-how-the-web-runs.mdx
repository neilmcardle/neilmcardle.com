...
This is part of the "your-code-vs-the-platform" thread: your code and the platform (the browser, the web) have different rules depending on where and how you run it. Local file access is not the same as web access.
...
<Section title="The error-location thread">

The "error-location-is-a-hint" thread runs through everything we just covered. When something breaks, the error message usually tells you where the problem is.
